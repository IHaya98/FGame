...
class Samurai extends Character {
  ...
  Samurai(FGame game, double x, double y) : super(game) {
    flyRect = Rect.fromLTWH(x, y, game.tileSize, game.tileSize);
    flyingSprite = <SpriteComponent>[];
    SpriteComponent sprite1 = SpriteComponent.fromSprite(
        60, 60, Sprite('actors/samurai.png', width: 60, height: 60));
    //sprite1.angle = Angle.degrees(270.0).radians;
    sprite1.renderFlipX = true;
    flyingSprite.add(sprite1);

    SpriteComponent sprite2 = SpriteComponent.fromSprite(
        60, 60, Sprite('actors/samurai.png', x: 320, width: 60, height: 60));
    //sprite2.angle = Angle.degrees(270.0).radians;
    flyingSprite.add(sprite2);

    SpriteComponent dead1 = SpriteComponent.fromSprite(60, 60,
